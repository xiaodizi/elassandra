...
import org.elasticsearch.benchmark.time.generated.DateFormatterBenchmark_jmhType;
public final class DateFormatterBenchmark_parseJodaDate_jmhTest {
    ...
    public BenchmarkTaskResult parseJodaDate_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "parseJodaDate", res.getTime(), benchmarkParams.getTimeUnit()));
            this.blackhole.evaporate("Yes, I am Stephen Hawking, and know a thing or two about black holes.");
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
